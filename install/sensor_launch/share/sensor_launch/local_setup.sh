...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/sensor_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sensor_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sensor_launch/environment/path.sh"
